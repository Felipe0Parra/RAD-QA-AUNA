...
SITIOS_DINAMICOS_PERMITIDOS = {
    ...
    ("data/ManejoDatos/load.py", 706): "DO1 (subirlineasmensuales -- SELECT del bloque vigente para componer el nuevo; ya filtra activo a mano, tabla dinámica)",
    ("data/ManejoDatos/load.py", 733): "DO1 (subirlineasmensuales, rama fuera del bloque de QC -- preguntas hasta PR1)",
    ("data/ManejoDatos/load.py", 873): "raíz (DP-31, diarias -- ya filtra activo a mano)",
    ("data/ManejoDatos/load.py", 204): "raíz (DP-31, diarias -- ya filtra activo a mano)",
    ("data/ManejoDatos/load.py", 995): "código muerto (mostrar_db_CambioFuente, sin llamadores)",
    ("data/ManejoDatos/load.py", 4547): "identidad (fila antes de anular/borrar)",
