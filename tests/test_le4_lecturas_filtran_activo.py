...
SITIOS_DINAMICOS_PERMITIDOS = {
    ...
    ("data/ManejoDatos/load.py", 680): "DO1 (subirlineasmensuales, rama INSERT-vs-UPDATE)",
    ("data/ManejoDatos/load.py", 822): "raíz (DP-31, diarias -- ya filtra activo a mano)",
    ("data/ManejoDatos/load.py", 204): "raíz (DP-31, diarias -- ya filtra activo a mano)",
    ("data/ManejoDatos/load.py", 944): "código muerto (mostrar_db_CambioFuente, sin llamadores)",
    ("data/ManejoDatos/load.py", 4496): "identidad (fila antes de anular/borrar)",
