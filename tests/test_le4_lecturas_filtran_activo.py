...
SITIOS_DINAMICOS_PERMITIDOS = {
    ...
    ("data/ManejoDatos/load.py", 721): "DO1/PR1 (subirlineasmensuales -- SELECT del bloque vigente, esquema completo para componer el nuevo sin perder columnas fuera de columnas_lista, p.ej. preguntas.imagen; ya filtra activo a mano, tabla dinámica)",
    ("data/ManejoDatos/load.py", 748): "PR1 (subirlineasmensuales, rama else -- ya no aplica a preguntas tras PR1, pero sigue alcanzable para cualquier tabla futura fuera de TABLAS_ANULABLES)",
    ("data/ManejoDatos/load.py", 888): "raíz (DP-31, diarias -- ya filtra activo a mano)",
    ("data/ManejoDatos/load.py", 204): "raíz (DP-31, diarias -- ya filtra activo a mano)",
    ("data/ManejoDatos/load.py", 1010): "código muerto (mostrar_db_CambioFuente, sin llamadores)",
