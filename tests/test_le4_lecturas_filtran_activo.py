...
EXCEPCIONES_LITERALES = {
    ...
    ("ui/paginasControles/PruebasDiarias/braquiterapia.py", 3300): "MaximosCamaras (filtro_mc, alias 'mc.') Y TipoCalibracion (filtro_tc, alias 'tc.', añadido en LR3) -- graficar_maximos_camara; las dos calificadas en variables intermedias",
    ...
    ("ui/paginasControles/PruebasDiarias/braquiterapia.py", 829): "TipoCalibracion -- filtro_tc calificado con el alias 'tc.' (_ejecutar_carga_calibracion: última fuente instalada antes de una fecha)",
    ("ui/paginasControles/PruebasDiarias/braquiterapia.py", 3329): "LinealidadBraquiterapia -- filtro_lf calificado con el alias 'lf.' (graficar_linealidad_fuente)",
...
SITIOS_CLAVE_INCOMPLETA_PERMITIDOS = {
    ...
    ("ui/paginasControles/PruebasDiarias/braquiterapia.py", 2038):
        "SistemaMedicion -- lectura por fecha en _ejecutar_carga_calibracion, "
        "debería ser por ref. Ver nota de la familia arriba.",
    ("ui/paginasControles/PruebasDiarias/braquiterapia.py", 2055):
        "CondicionesMedicion -- mismo defecto, misma función.",
    ("ui/paginasControles/PruebasDiarias/braquiterapia.py", 2058):
        "ResultadosActividad -- mismo defecto, misma función.",
    ("ui/paginasControles/PruebasDiarias/braquiterapia.py", 2069):
