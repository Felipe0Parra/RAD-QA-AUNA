...
SITIOS_OPACOS_PERMITIDOS = {
    ...
    ("ui/paginasControles/PruebasMensuales/seiscientos_mensual.py", 4065): "DO1 (pruebatalas -- `sql += filtro_activo(nombre_tabla)` es una llamada real, no un literal; ya documentado en el propio archivo como filtrado a mano)",  # R.3 (11-09): 3911->3922
