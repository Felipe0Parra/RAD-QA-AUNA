...
SITIOS_LITERALES_PERMITIDOS = {
    ...
    ("ui/paginasControles/PruebasMensuales/seiscientos_mensual.py", 3444):
...
SITIOS_DINAMICOS_PERMITIDOS = {
    ...
    ("ui/paginasControles/PruebasDiarias/PruebasDiarias.py", 826):
...
SITIOS_OPACOS_PERMITIDOS = {
    ...
    ("ui/paginasControles/PruebasMensuales/seiscientos_mensual.py", 3795):
