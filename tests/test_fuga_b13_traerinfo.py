"""B13 (PLAN_FUGA_CONEXIONES_01-09.md §8.1/§4, hallazgo de la auditoría):
`seiscientos_mensual.py::Traerinfo` -- RIESGO BAJO, solo lectura: nunca
cerraba `conn`. [medido] 3 descriptores por llamada.

Nota de proceso: ver test_fuga_b11 -- el with de este sitio se aplicó en
el mismo lote que B10-B12/B14-B15 antes de escribir su test individual;
...
class TestB13TraerinfoCierraSiempre:
