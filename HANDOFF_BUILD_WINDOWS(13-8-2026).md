# Revision Rebuild windows 13 de Agosto de 2026

- Equipos de medicion, control cunas y conos hacen insert con cada guardado esto no me convence del todo, hay alguna necesidad real de dejar esto asi? Porque no simplemente le damos la misma estructura que tienen las otras tablas? o todas tienen la misma estrutura solo que el guardado de cada una es diferente o esta mas visible o en otras situaciones? Es correcto segun la normativa o nuestra referencia o las buenas practicas hacer esto? Ir anadiendo archivos deactivados con cada guardado? Que se recomienda para esto? 

- Aun no arreglamos que se vuelva a bloquear la edicion de un equipo luego de haberle dado Aceptar o cancelar a los botones debajo de los widgets de edicion, bueno, con cancelar si funciona, el boton de aceptar tambien funciona pero me refiero a que luego de aplicar los cambios tambien deberia volver a bloquearse luego de darle aceptar.

- El excel solo muestra las primeras 30 filas, y son las viejas, deberia mostrar todo y ya.

- Expulsion de la terminal:

(.venv) PS C:\Users\parra\Documents\AUNA_Codigos_2026\Codigo_radqa_2026-08-13> python main.py
admin2025
...
iniGUI: 0.023s
load table: 0.092s
asignar_encabezados: 0.098s
button_click: 0.099s
Clinac ix
id_f1 recibido: <data.ManejoDatos.user.Usuario object at 0x000002AC997A21D0>, id_f1_num usado: Administrador
...
<PyQt5.QtWidgets.QGridLayout object at 0x000002AD3C5E6DD0>
<PyQt5.QtWidgets.QGridLayout object at 0x000002AD3C5E6D40>
<PyQt5.QtWidgets.QGridLayout object at 0x000002AD3C5E6EF0>
<PyQt5.QtWidgets.QGridLayout object at 0x000002AD3C5E6E60>
<PyQt5.QtWidgets.QGridLayout object at 0x000002AD3C5E6F80>
DF LINES: 
...
line: observaciones_segu, widget: <PyQt5.QtWidgets.QLineEdit object at 0x000002AD3C6C5900>
...
Respaldo de la base de datos creado en: C:\Users\parra\Documents\AUNA_Codigos_2026\Codigo_radqa_2026-08-13\respaldos_bd\BaseDatosQA_2026-08-13_102440.db
...
button_click: 0.095s
Clinac ix
id_f1 recibido: <data.ManejoDatos.user.Usuario object at 0x000001D990B68890>, id_f1_num usado: Administrador
Consulta de físicos: el usuario actual no aparece en la lista de físicos (role='Físico Médico') -- normal si quien inició sesión no tiene ese rol
Físico 2 seleccionado:  Andres David Loaiza Baena, ID: 6
user_id_f2 antes de create_control: 6
Entrando a crear control
...
CREADO: ln_sid_starshot
  - DataFrame: 289 filas
Layouts disponibles: 5
<PyQt5.QtWidgets.QGridLayout object at 0x000001DA3D4ABA30>
<PyQt5.QtWidgets.QGridLayout object at 0x000001DA3D4AB9A0>
<PyQt5.QtWidgets.QGridLayout object at 0x000001DA3D4ABB50>
<PyQt5.QtWidgets.QGridLayout object at 0x000001DA3D4ABAC0>
<PyQt5.QtWidgets.QGridLayout object at 0x000001DA3D4ABBE0>
DF LINES: 
['puntero_telem_diff', 'lbl_telem_rango', 'lbl_telem_desp', 'lbl_camilla_vert_rango', 'lbl_camilla_vert_desp', 'lbl_camilla_iso_desp', 'lbl_reticulo_cent', 'lbl_iso_mec', 'camp_luz_desp', 'lbl_bordes_coin', 'lbl_laser_techo', 'lbl_laser_lateral27', 'lbl_laser_lateral9', 'observaciones']
Configurando dosimetría para equipo IX
...
Actualizando tabla de controles mensuales para Clinac ix
Actualizando tabla de controles mensuales para Clinac ix
Respaldo de la base de datos creado en: C:\Users\parra\Documents\AUNA_Codigos_2026\Codigo_radqa_2026-08-13\respaldos_bd\BaseDatosQA_2026-08-13_103249.db
admin2025
ANTES ADD: btn_2_laseres False
CREADO: btn_2_laseres
ANTES ADD: btn_2_telemetro False
...
button_click: 0.091s
Clinac ix
id_f1 recibido: <data.ManejoDatos.user.Usuario object at 0x000001DA3ABCA110>, id_f1_num usado: Administrador
Consulta de físicos: el usuario actual no aparece en la lista de físicos (role='Físico Médico') -- normal si quien inició sesión no tiene ese rol
Físico 2 seleccionado:  Andres David Loaiza Baena, ID: 6
user_id_f2 antes de create_control: 6
Entrando a crear control
...
CREADO: ln_sid_starshot
  - DataFrame: 289 filas
Layouts disponibles: 5
<PyQt5.QtWidgets.QGridLayout object at 0x000001D9DAD5F1C0>
<PyQt5.QtWidgets.QGridLayout object at 0x000001D9DAD5F130>
<PyQt5.QtWidgets.QGridLayout object at 0x000001D9DAD5F250>
<PyQt5.QtWidgets.QGridLayout object at 0x000001D9DAD5F2E0>
<PyQt5.QtWidgets.QGridLayout object at 0x000001D9DAD5F370>
DF LINES: 
['puntero_telem_diff', 'lbl_telem_rango', 'lbl_telem_desp', 'lbl_camilla_vert_rango', 'lbl_camilla_vert_desp', 'lbl_camilla_iso_desp', 'lbl_reticulo_cent', 'lbl_iso_mec', 'camp_luz_desp', 'lbl_bordes_coin', 'lbl_laser_techo', 'lbl_laser_lateral27', 'lbl_laser_lateral9', 'observaciones']
Configurando dosimetría para equipo IX
...
Widgets MLC encontrados y configurados
 ...
 -> Entra en subir_control_cunas en 600
line: observaciones_segu, widget: <PyQt5.QtWidgets.QLineEdit object at 0x000001D9DAD6DCF0>
Texto actual en observaciones_segu: ''
Datos de control de cuñas insertados correctamente
Actualizando tabla de controles mensuales para Clinac ix
